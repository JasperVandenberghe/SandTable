...
TEETH_PULLEY = 30.0
TEETH_BELT = 312#310.5 # 309/311?
GEAR_RATIO = TEETH_BELT / TEETH_PULLEY
STEPS_DISK_ROTATION = 200.0 * FACTOR[MOTOR_ROT_RES] * GEAR_RATIO

STEPS_FULL_MODE_LENGTH = 1720 #1894 is full, but prevent touching the switch by reducing with 10 steps
STEPS_FULL_MODE_SHORT = 434 #415
...
DEFAULT_SPEED = 2100.0#1300.0#1800.0
MAX_SPEED = 2500.0#1600.0#2200.0

# LED constants
RAINBOW_WAIT_TIME_MS = 5000
